...
#------------------------
#design<-read.csv("LKJ_ExpDesign.csv",row.names=1)
#head(design)
#species<-design$species
#clade<-design$clade
#species_clade<-design$species_clade
#condition<-design$condition
#species_condition<-design$species_condition
#fake_species<-design$species_fake
...
#m1 <- model.matrix(~condition + clade:condition + species:condition,ExpDesign)
#m0 <- model.matrix(~condition + clade:condition)

m1 <- model.matrix(~ species + clade + condition + species:condition)
colnames(m1)
...
res_Fcatanatus_BW_v_FW <- results(dds, tidy=TRUE, contrast("Intercept","condition15_ppt")) %>% arrange(padj) %>% tbl_df()

# all others
res_Fdiaphanus_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_diaphanus") %>% arrange(padj) %>% tbl_df()
res_Fgrandis_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_grandis") %>% arrange(padj) %>% tbl_df()
res_FheteroclitusMDPL_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_heteroclitusMDPL") %>% arrange(padj) %>% tbl_df() 
res_FheteroclitusMDPP_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_heteroclitusMDPP") %>% arrange(padj) %>% tbl_df() 
res_Frathbuni_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_rathbuni") %>% arrange(padj) %>% tbl_df()
res_Fsimilis_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_similis") %>% arrange(padj) %>% tbl_df()         
res_Fparvapinis_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_parvapinis") %>% arrange(padj) %>% tbl_df()     
res_Lgoodei_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesL_goodei") %>% arrange(padj) %>% tbl_df()        
res_Lparva_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesL_parva") %>% arrange(padj) %>% tbl_df()           
res_Axenica_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesA_xenica") %>% arrange(padj) %>% tbl_df()       
res_Fchrysotus_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_chrysotus") %>% arrange(padj) %>% tbl_df()             
res_Fnotatus_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_notatus") %>% arrange(padj) %>% tbl_df()          
res_Folivaceous_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_olivaceous") %>% arrange(padj) %>% tbl_df()   
res_Fsciadicus_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_sciadicus") %>% arrange(padj) %>% tbl_df()   
res_Fzebrinus_BW_v_FW <- results(dds, tidy=TRUE, name="condition15_ppt.speciesF_zebrinus") %>% arrange(padj) %>% tbl_df()           
...
# Clade1_F_catanatus (reference level)
res_Fcatanatus_TR_v_FW <- results(dds, tidy=TRUE, contrast("Intercept","conditiontransfer")) %>% arrange(padj) %>% tbl_df()

# all others
res_Fdiaphanus_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_diaphanus") %>% arrange(padj) %>% tbl_df()
res_Fgrandis_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_grandis") %>% arrange(padj) %>% tbl_df()
res_FheteroclitusMDPL_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_heteroclitusMDPL") %>% arrange(padj) %>% tbl_df() 
res_FheteroclitusMDPP_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_heteroclitusMDPP") %>% arrange(padj) %>% tbl_df() 
res_Frathbuni_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_rathbuni") %>% arrange(padj) %>% tbl_df()
res_Fsimilis_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_similis") %>% arrange(padj) %>% tbl_df()         
res_Fparvapinis_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesF_parvapinis") %>% arrange(padj) %>% tbl_df()     
res_Lgoodei_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesL_goodei") %>% arrange(padj) %>% tbl_df()        
res_Lparva_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesL_parva") %>% arrange(padj) %>% tbl_df()           
res_Axenica_TR_v_FW <- results(dds, tidy=TRUE, name="conditiontransfer.speciesA_xenica") %>% arrange(padj) %>% tbl_df()       
...
# what are the genes that are different in BW treatment compared to transfer in each species?
# Clade1_F_catanatus (reference level)
res_Fcatanatus_BW_v_TR <- results(dds, tidy=TRUE, contrast("codition15_ppt","conditiontransfer") %>% arrange(padj) %>% tbl_df()
