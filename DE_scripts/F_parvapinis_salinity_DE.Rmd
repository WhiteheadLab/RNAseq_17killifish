...
The following is a DE analysis with *Fundulus parvapinis* to identify candidate genes for downstream comparative gene expression analysis.

These are the quantification files, and whether they exist:

```{r, echo = FALSE}
dir="../salmon_denovo_by_species"
files_list = list.files("../salmon_denovo_by_species/F_parvapinis")
...
all_matrix <- all_matrix[,c(1:21,23,24,26,28)]
