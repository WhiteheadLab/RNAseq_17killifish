...
This is the PCA with all counts, not filtered. The dimensions of the counts table are listed below, above the PCA plot. (row=genes, columns=samples)
```{r PCA of counts,}
# normal full counts
...
The following shows the dimensions of the dataframe when we filter out low counts several.
