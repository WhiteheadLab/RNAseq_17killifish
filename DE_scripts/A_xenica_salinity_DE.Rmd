---
title: "Multiple Fundulus killifish osmotic challenge RNAseq, Differential Expression by species"
...
The following is just DE analysis with the *Adinia xenica* species as example species to test. Will later do this on each species separate, then look at up-down trends per species, as a quantifiable trait to compare between clades in a phylogenetic context. This is just to identify candidate genes to be interested in for downstream analysis.
...
files_list = list.files("~/Documents/UCDavis/Whitehead/RNAseq_15killifish/salmon_denovo_by_species/A_xenica")
...
heatmap.2(d, main="Adenia xenica (padj<0.05, log2FC = ±1)", 
...
write.csv(TR_BW_all,"~/Documents/UCDavis/Whitehead/RNAseq_15killifish/DE_results/A_xenica_DE_TR_FW.csv")
```
