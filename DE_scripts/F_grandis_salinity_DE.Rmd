...
The following is a DE analysis with *Fundulus grandis* to identify candidate genes for downstream comparative gene expression analysis.

These are the quantification files, and whether they exist:

```{r, echo = FALSE}
dir="../salmon_denovo_by_species"
files_list = list.files("../salmon_denovo_by_species/F_grandis")
...
cols<-c("Row","Trinity_contigID","Trinity_gene","dammit_ID","GeneID","dammit_ID2","NCBI_Fhet")
...
all_matrix <- all_matrix[,c(1:28,30,31,32,34)]
...
write.csv(BW_FW_all,"~/Documents/UCDavis/Whitehead/RNAseq_15killifish/DE_results/F_grandis_DE_BW_FW.csv")
```
