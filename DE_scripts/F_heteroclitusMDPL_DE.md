...
---
title: "RNAseq, DE analysis for F_heteroclitusMDPL killifish osmotic challenge"
...
design <- design[ , startsWith(names(design),"F_heteroclitusMDPL")]
counts <- counts[ , startsWith(names(counts),"F_heteroclitusMDPL")]
dim(design)
```
...
```
##                                     condition
## F_heteroclitusMDPL_BW_1.quant          15_ppt
## F_heteroclitusMDPL_BW_2.quant          15_ppt
## F_heteroclitusMDPL_BW_3.quant          15_ppt
## F_heteroclitusMDPL_FW_1.quant         0.2_ppt
## F_heteroclitusMDPL_FW_2.quant         0.2_ppt
## F_heteroclitusMDPL_FW_3.quant         0.2_ppt
## F_heteroclitusMDPL_transfer_1.quant  transfer
## F_heteroclitusMDPL_transfer_2.quant  transfer
## F_heteroclitusMDPL_transfer_3.quant  transfer
```
...
<img src="figure/F-heteroclitusMDPL-DE-RmdDESeq QC-1.png" title="plot of chunk DESeq QC" alt="plot of chunk DESeq QC" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-RmdDESeq QC-2.png" title="plot of chunk DESeq QC" alt="plot of chunk DESeq QC" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-RmdPCA of counts-1.png" title="plot of chunk PCA of counts" alt="plot of chunk PCA of counts" style="display: block; margin: auto;" />
...
## Standard deviation     6.7567 5.6623 5.4817 5.1066 4.9680 4.7542 4.65883
## Proportion of Variance 0.2045 0.1436 0.1346 0.1168 0.1106 0.1013 0.09723
## Cumulative Proportion  0.2045 0.3481 0.4827 0.5995 0.7101 0.8114 0.90857
##                            PC8       PC9
## Standard deviation     4.51773 1.252e-14
## Proportion of Variance 0.09143 0.000e+00
## Cumulative Proportion  1.00000 1.000e+00
```

<img src="figure/F-heteroclitusMDPL-DE-RmdPCA of counts-2.png" title="plot of chunk PCA of counts" alt="plot of chunk PCA of counts" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     ...
     main="F_heteroclitusMDPL (15_ppt vs. 0.2_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
...
<img src="figure/F-heteroclitusMDPL-DE-RmdMA plot 1-1.png" title="plot of chunk MA plot 1" alt="plot of chunk MA plot 1" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     col=ifelse(res$padj < 0.05, "red","gray67"),
     main="F_heteroclitusMDPL (transfer vs. 0.2_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
abline(h=c(-1,1), col="blue")
resSig = res_ordered[rownames(res_ordered) %in% protein_id, ]
dim(resSig)
```
...
<img src="figure/F-heteroclitusMDPL-DE-RmdMA plot 2-1.png" title="plot of chunk MA plot 2" alt="plot of chunk MA plot 2" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     col=ifelse(res$padj < 0.05, "red","gray67"),
     main="F_heteroclitusMDPL (transfer vs. 15_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
abline(h=c(-1,1), col="blue")
resSig = res_ordered[rownames(res_ordered) %in% protein_id, ]
dim(resSig)
```
...
<img src="figure/F-heteroclitusMDPL-DE-RmdMA plot 3-1.png" title="plot of chunk MA plot 3" alt="plot of chunk MA plot 3" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 1-1.png" title="plot of chunk plot goi 1" alt="plot of chunk plot goi 1" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 2-1.png" title="plot of chunk plot goi 2" alt="plot of chunk plot goi 2" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 3-1.png" title="plot of chunk plot goi 3" alt="plot of chunk plot goi 3" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 4-1.png" title="plot of chunk plot goi 4" alt="plot of chunk plot goi 4" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 5-1.png" title="plot of chunk plot goi 5" alt="plot of chunk plot goi 5" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 6-1.png" title="plot of chunk plot goi 6" alt="plot of chunk plot goi 6" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 7-1.png" title="plot of chunk plot goi 7" alt="plot of chunk plot goi 7" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 8-1.png" title="plot of chunk plot goi 8" alt="plot of chunk plot goi 8" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 9-1.png" title="plot of chunk plot goi 9" alt="plot of chunk plot goi 9" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 10-1.png" title="plot of chunk plot goi 10" alt="plot of chunk plot goi 10" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 11-1.png" title="plot of chunk plot goi 11" alt="plot of chunk plot goi 11" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 12-1.png" title="plot of chunk plot goi 12" alt="plot of chunk plot goi 12" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 13-1.png" title="plot of chunk plot goi 13" alt="plot of chunk plot goi 13" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 14-1.png" title="plot of chunk plot goi 14" alt="plot of chunk plot goi 14" style="display: block; margin: auto;" />
...
<img src="figure/F-heteroclitusMDPL-DE-Rmdplot goi 15-1.png" title="plot of chunk plot goi 15" alt="plot of chunk plot goi 15" style="display: block; margin: auto;" />
...
## Batch submitting query [=>------------------------] 7% eta: 23s
## Batch submitting query [=>------------------------] 8% eta: 22s
## Batch submitting query [==>-----------------------] 10% eta: 27s
## Batch submitting query [==>-----------------------] 11% eta: 25s
## Batch submitting query [==>-----------------------] 13% eta: 24s
## Batch submitting query [===>----------------------] 15% eta: 23s
## Batch submitting query [===>----------------------] 16% eta: 22s
## Batch submitting query [====>---------------------] 18% eta: 21s
## Batch submitting query [====>---------------------] 20% eta: 20s
## Batch submitting query [=====>--------------------] 21% eta: 19s
## Batch submitting query [=====>--------------------] 23% eta: 18s
## Batch submitting query [=====>--------------------] 25% eta: 18s
## Batch submitting query [======>-------------------] 26% eta: 17s
## Batch submitting query [======>-------------------] 28% eta: 18s
## Batch submitting query [=======>------------------] 30% eta: 19s
## Batch submitting query [=======>------------------] 31% eta: 19s
## Batch submitting query [========>-----------------] 33% eta: 18s
## Batch submitting query [========>-----------------] 34% eta: 17s
## Batch submitting query [========>-----------------] 36% eta: 17s
## Batch submitting query [=========>----------------] 38% eta: 16s
## Batch submitting query [=========>----------------] 39% eta: 16s
## Batch submitting query [==========>---------------] 41% eta: 15s
## Batch submitting query [==========>---------------] 43% eta: 15s
## Batch submitting query [===========>--------------] 44% eta: 14s
## Batch submitting query [===========>--------------] 46% eta: 14s
## Batch submitting query [===========>--------------] 48% eta: 13s
## Batch submitting query [============>-------------] 49% eta: 13s
## Batch submitting query [============>-------------] 51% eta: 13s
## Batch submitting query [=============>------------] 52% eta: 12s
## Batch submitting query [=============>------------] 54% eta: 12s
## Batch submitting query [=============>------------] 56% eta: 12s
## Batch submitting query [==============>-----------] 57% eta: 11s
...
## Batch submitting query [================>---------] 67% eta: 9s
## Batch submitting query [=================>--------] 69% eta: 8s
## Batch submitting query [=================>--------] 70% eta: 8s
...
write.csv(counts_table_ann,"/Users/johnsolk/Documents/UCDavis/Whitehead/counts_stats_byspecies/F_heteroclitusMDPL_stats_annotations_counts.csv")
```
