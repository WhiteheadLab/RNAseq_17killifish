...
design <- design[ , startsWith(names(design),"F_grandis")]
counts <- counts[ , startsWith(names(counts),"F_grandis")]
dim(design)
```
...
```
##                            condition
## F_grandis_BW_1.quant          15_ppt
## F_grandis_BW_2.quant          15_ppt
## F_grandis_BW_3.quant          15_ppt
## F_grandis_FW_1.quant         0.2_ppt
## F_grandis_FW_2.quant         0.2_ppt
## F_grandis_FW_3.quant         0.2_ppt
## F_grandis_transfer_1.quant  transfer
## F_grandis_transfer_2.quant  transfer
## F_grandis_transfer_3.quant  transfer
```
...
<img src="figure/F-grandis-DE-RmdDESeq QC-1.png" title="plot of chunk DESeq QC" alt="plot of chunk DESeq QC" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-RmdDESeq QC-2.png" title="plot of chunk DESeq QC" alt="plot of chunk DESeq QC" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-RmdPCA of counts-1.png" title="plot of chunk PCA of counts" alt="plot of chunk PCA of counts" style="display: block; margin: auto;" />
...
## Standard deviation     11.8519 8.8132 8.2429 7.3572 6.6942 6.20385 6.05047
## Proportion of Variance  0.2887 0.1596 0.1396 0.1113 0.0921 0.07911 0.07524
## Cumulative Proportion   0.2887 0.4484 0.5880 0.6993 0.7914 0.87047 0.94571
##                            PC8       PC9
## Standard deviation     5.13940 1.166e-14
## Proportion of Variance 0.05429 0.000e+00
## Cumulative Proportion  1.00000 1.000e+00
```

<img src="figure/F-grandis-DE-RmdPCA of counts-2.png" title="plot of chunk PCA of counts" alt="plot of chunk PCA of counts" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     ...
     main="F_grandis (15_ppt vs. 0.2_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
...
<img src="figure/F-grandis-DE-RmdMA plot 1-1.png" title="plot of chunk MA plot 1" alt="plot of chunk MA plot 1" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     col=ifelse(res$padj < 0.05, "red","gray67"),
     main="F_grandis (transfer vs. 0.2_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
abline(h=c(-1,1), col="blue")
resSig = res_ordered[rownames(res_ordered) %in% protein_id, ]
dim(resSig)
```
...
<img src="figure/F-grandis-DE-RmdMA plot 2-1.png" title="plot of chunk MA plot 2" alt="plot of chunk MA plot 2" style="display: block; margin: auto;" />
...
plot(log2(res$baseMean), res$log2FoldChange, 
     col=ifelse(res$padj < 0.05, "red","gray67"),
     main="F_grandis (transfer vs. 15_ppt) (padj<0.05)",xlim=c(1,15),pch=20,cex=1)
abline(h=c(-1,1), col="blue")
resSig = res_ordered[rownames(res_ordered) %in% protein_id, ]
dim(resSig)
```
...
<img src="figure/F-grandis-DE-RmdMA plot 3-1.png" title="plot of chunk MA plot 3" alt="plot of chunk MA plot 3" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 1-1.png" title="plot of chunk plot goi 1" alt="plot of chunk plot goi 1" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 2-1.png" title="plot of chunk plot goi 2" alt="plot of chunk plot goi 2" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 3-1.png" title="plot of chunk plot goi 3" alt="plot of chunk plot goi 3" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 4-1.png" title="plot of chunk plot goi 4" alt="plot of chunk plot goi 4" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 5-1.png" title="plot of chunk plot goi 5" alt="plot of chunk plot goi 5" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 6-1.png" title="plot of chunk plot goi 6" alt="plot of chunk plot goi 6" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 7-1.png" title="plot of chunk plot goi 7" alt="plot of chunk plot goi 7" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 8-1.png" title="plot of chunk plot goi 8" alt="plot of chunk plot goi 8" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 9-1.png" title="plot of chunk plot goi 9" alt="plot of chunk plot goi 9" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 10-1.png" title="plot of chunk plot goi 10" alt="plot of chunk plot goi 10" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 11-1.png" title="plot of chunk plot goi 11" alt="plot of chunk plot goi 11" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 12-1.png" title="plot of chunk plot goi 12" alt="plot of chunk plot goi 12" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 13-1.png" title="plot of chunk plot goi 13" alt="plot of chunk plot goi 13" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 14-1.png" title="plot of chunk plot goi 14" alt="plot of chunk plot goi 14" style="display: block; margin: auto;" />
...
<img src="figure/F-grandis-DE-Rmdplot goi 15-1.png" title="plot of chunk plot goi 15" alt="plot of chunk plot goi 15" style="display: block; margin: auto;" />
...
## Batch submitting query [==>-----------------------] 11% eta: 20s
## Batch submitting query [==>-----------------------] 13% eta: 20s
## Batch submitting query [===>----------------------] 15% eta: 21s
## Batch submitting query [===>----------------------] 16% eta: 25s
## Batch submitting query [====>---------------------] 18% eta: 23s
## Batch submitting query [====>---------------------] 20% eta: 22s
## Batch submitting query [=====>--------------------] 21% eta: 23s
## Batch submitting query [=====>--------------------] 23% eta: 22s
## Batch submitting query [=====>--------------------] 25% eta: 21s
## Batch submitting query [======>-------------------] 26% eta: 20s
## Batch submitting query [======>-------------------] 28% eta: 21s
## Batch submitting query [=======>------------------] 30% eta: 20s
## Batch submitting query [=======>------------------] 31% eta: 21s
## Batch submitting query [========>-----------------] 33% eta: 21s
## Batch submitting query [========>-----------------] 34% eta: 20s
...
## Batch submitting query [===========>--------------] 46% eta: 16s
...
## Batch submitting query [================>---------] 66% eta: 11s
...
write.csv(counts_table_ann,"/Users/johnsolk/Documents/UCDavis/Whitehead/counts_stats_byspecies/F_grandis_stats_annotations_counts.csv")
```
