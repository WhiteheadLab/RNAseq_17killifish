...
for (species in files_list){
  ...
  print(dim(contigs))
  gene_names_file = paste("~/Documents/UCDavis/Whitehead/Fhet_counts_ncbi/",species,sep="")
  gene_names <- read.csv(paste(gene_names_file,"_genenames.csv_NCBI.csv",sep=""))
  print(gene_names_file)
  print(dim(gene_names))
  gene_names_id <- gene_names[,c(2,12)]
  ...
  counts_matrix = paste("~/Documents/UCDavis/Whitehead/counts_matrices/",species,sep="")
