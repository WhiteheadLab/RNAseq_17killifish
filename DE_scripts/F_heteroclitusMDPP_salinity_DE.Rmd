...
The following is a DE analysis with the freshwater native, *Fundulus heteroclitus (MDPP)* killifish to identify candidate genes to be interested in for downstream analysis.
...
files_list = list.files("~/Documents/UCDavis/Whitehead/RNAseq_15killifish/salmon_denovo_by_species/F_heteroclitusMDPP")
...
heatmap.2(d, main="Fundulus heteroclitus MDPP (padj<0.05, log2FC = ±1)", 
...
write.csv(TR_BW_all,"~/Documents/UCDavis/Whitehead/RNAseq_15killifish/DE_results/F_heteroclitusMDPP_DE_TR_FW.csv")
```
